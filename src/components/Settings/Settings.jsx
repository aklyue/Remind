        ...
        if (formValid) {
            ...
            try {
                ...
                if (avatarFile) {
                    ...
                    const uploadResponse = await fetch(`http://localhost:3001/upload-avatar`, {
                        method: 'POST',
                        body: formData,
                    });
        ...
        <div className={c.settingsWrapper}>
            <form onSubmit={submitHandler} className={c.settingsForm}>
                <div className={c.inputGroup}>
                    ...
                    {fieldsDirty.email && emailError && <div className={c.error}>{emailError}</div>}
                    <input
                ...
                <div className={c.inputGroup}>
                    ...
                    {avatar && <img src={avatar} alt="Avatar Preview" className={c.avatarPreview} />}
                    <input onChange={avatarHandler} type="file" accept="image/*" name="avatar" className={c.fileInput} />
                </div>
                ...
                <div>
                    <button type="submit" className={c.saveButton}>Save</button>
                </div>
            </form>
        </div>
    );
